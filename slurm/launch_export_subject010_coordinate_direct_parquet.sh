#!/bin/bash
# Full subject010 mask05 export for [S1,S2,dS2/dt].
#SBATCH --job-name=coord-s010-parquet
#SBATCH --output=logs/coord-s010-parquet_%j.out
#SBATCH --error=logs/coord-s010-parquet_%j.err
...
export MPLCONFIGDIR="${TMPDIR:-/tmp}/matplotlib-coord-s010-${SLURM_JOB_ID}"
...
echo "[$(date --iso-8601=seconds)] subject010 coordinate Parquet validated"
