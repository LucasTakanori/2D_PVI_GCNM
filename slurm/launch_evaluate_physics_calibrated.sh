#!/bin/bash
#SBATCH --job-name=gcnm-physcal-eval
#SBATCH --output=logs/gcnm-physcal-eval_%j.out
#SBATCH --error=logs/gcnm-physcal-eval_%j.err
...
python -u -m gcnm_pvi.evaluate_physics_calibrated_gcnm "${ARGS[@]}"
